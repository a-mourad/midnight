...
@section('content')
    ...
    <div class="card" style="width: 18rem;">
        <a href="{{ route('companies.services.create', ['company' => $company->id]) }}" class="btn btn-primary">Create New
            Service</a>
        @foreach ($services as $service)
            <div class="row">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('companies.show', ['company' => $service->company]) }}" class="btn btn-primary">Show
                        Company</a>
