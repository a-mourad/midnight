...
@endif
    ...
    <div class="mb-6">
       ...
       <textarea name="description" id="" cols="30" rows="10" placeholder ="enter description">{{$service->description}}</textarea>
    ...
    <div class="mb-6">
       ...
       <img class="w-48 mr-6 mb-6"
              src="{{$service->image ? asset('storage/' . $service->image) : asset('/images/no-image.png')}}" alt="" />
     </div>
    ...
    <label for="min_budget" class="inline-block text-lg mb-2">
       ...
       <input type="number" name="min_budget" placeholder="Min Budget" value="{{$service->min_budget}}">
